// Import presentation.json as a module for HMR support
import presentationData from "./presentation.json";

// Development mode - dynamic loading
if (import.meta.env.DEV) {
  // Set up HMR for presentation.json
  if (import.meta.hot) {
    import.meta.hot.accept("./presentation.json", () => {
  ...
  async function main() {
    try {
      // Use the imported presentation data instead of fetching
